%%CODE TO SHOW THE IS-LM MODEL BY HICKS-HANSEN (1937)


%%Very interesting if you want to implement a very simple code to show the graphs
%%through Matlab for an experimental thesis with notions of economic policy (or macroeconomics).
