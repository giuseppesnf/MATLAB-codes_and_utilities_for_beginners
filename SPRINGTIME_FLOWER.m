%%CODE FOR SPRINGTIME FLOWER

%%This can be very useful in order to try to work a little with graphics using the Matlab language.
%%In fact, it is possible to change the characteristics of the flower by modifying the following code.
